...
public class CodingAlgorithmCaesar {
    ...
    public static String encryption(String newString, int k) throws IOException {
        char[] myList = new char[newString.length()];
        newString.getChars(0,newString.length(), myList, 0);
    ...
    public static String decryption(String myString, int k) throws IOException {
